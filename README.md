...
Edit `app.py` and add commands to the `COMMANDS` list:

```python
{
    'id': 'unique_id',
    'label': 'Command Label',
    'command': 'your-command-here with {domain} placeholder'
}
```

### Customizing Domain Placeholders

Edit `DOMAIN_PLACEHOLDERS` in `app.py`:

```python
DOMAIN_PLACEHOLDERS = [
    'example.com', 'domain.com', 'target.com', ...
]
```
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/ReconForge/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/ReconForge/discussions)
